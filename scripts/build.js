...
function getDeploymentDomain() {
  if (process.env.APP_PUBLIC_DOMAIN) {
    return stripProtocol(process.env.APP_PUBLIC_DOMAIN);
  }
  ...
  console.error(
    "ERROR: No deployment domain found. Set APP_PUBLIC_DOMAIN, REPLIT_INTERNAL_APP_DOMAIN, REPLIT_DEV_DOMAIN, or EXPO_PUBLIC_DOMAIN",
  );
  process.exit(1);
}
...
function getExpoPublicReplId() {
  return process.env.REPL_ID || process.env.APP_PUBLIC_REPL_ID || process.env.EXPO_PUBLIC_REPL_ID;
}
